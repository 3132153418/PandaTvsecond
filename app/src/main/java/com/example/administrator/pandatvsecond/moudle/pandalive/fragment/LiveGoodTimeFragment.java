...
import com.example.administrator.pandatvsecond.moudle.pandalive.adapter.GoodTimeAdapter;
...
public class LiveGoodTimeFragment extends LiveBaseFragment implements LiveContract.View{
    private LiveContract.Presenter presenter;
    private XRecyclerView goodtime_recyclerview;

    @Override
    protected int getLayoutId() {
        return R.layout.live_goodtimefragment;
    }
    ...
    protected void initView(View view) {
        ...
        goodtime_recyclerview.setLoadingMoreEnabled(false);
        goodtime_recyclerview.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override
    ...
    protected void loadData() {
        presenter.requestGoodTimeFragmentData();
    }
    ...
    public void GoodTimeBeanResult(GoodTimeBean goodTimeBean) {
        goodtime_recyclerview.setAdapter(new GoodTimeAdapter(getActivity(),goodTimeBean));
    }
