package com.example.administrator.pandatvsecond.moudle.mine.setting;
...
import com.example.administrator.pandatvsecond.model.bean.CommonQuestionBean;
...
public class ChangJianPloblem extends BaseFragment {
    ...
    Unbinder unbinder;
    List<CommonQuestionBean> mListData=new ArrayList<>();
    ...
    protected int getLayoutId() {
        return R.layout.personal_feedback_commonquestion;
    }
    ...
    protected void loadData() {
        ...
        try {
            ...
            TreeMap<Integer, CommonQuestionBean> tmap = new TreeMap<Integer, CommonQuestionBean>();
            while(it.hasNext()){
                String key = it.next().toString();
                CommonQuestionBean cqm = new CommonQuestionBean();
                cqm.setTitle(key);
