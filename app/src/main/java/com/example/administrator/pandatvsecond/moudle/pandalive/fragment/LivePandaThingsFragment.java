...
public class LivePandaThingsFragment extends LiveBaseFragment implements LiveContract.View{
    private LiveContract.Presenter presenter;
    private XRecyclerView pandathings_recyclerview;
    ...
    protected void initView(View view) {
        ...
        pandathings_recyclerview.setLoadingMoreEnabled(false);
        pandathings_recyclerview.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override
    ...
    protected void loadData() {
        presenter.requestPandaThingsFragmentData();
    }
    ...
    public void PandaThingsBeanResult(NoBearBean noBearBean) {
        pandathings_recyclerview.setAdapter(new NoBeerAdapter(getActivity(),noBearBean));
    }
