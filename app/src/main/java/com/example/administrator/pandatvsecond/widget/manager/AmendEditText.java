...
public class AmendEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    public AmendEditText(Context context) {
        this(context, null);
    }

    public AmendEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public AmendEditText(Context context, AttributeSet attrs, int defStyle) {
