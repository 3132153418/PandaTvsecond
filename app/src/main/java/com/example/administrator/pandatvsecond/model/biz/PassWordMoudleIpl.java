...
import static com.example.administrator.pandatvsecond.base.BaseModel.ihttp;

/**
 * Created by Administrator on 2017/7/22.
 */

public class PassWordMoudleIpl implements PassWordMoudle {
    @Override
    public void setPwd(MyCallBack callBack) {
       ihttp.loginPost(Urls.EMILEYANZHENG,null,null,callBack);
    }

    @Override
    public void setPwdYz(String number, String yanzm, MyCallBack callBack) {
    ...
    @Override
    public void findPwdBtn(String number, String yanzm, String pwd, MyCallBack callBack) {
