...
import com.example.administrator.pandatvsecond.moudle.pandalive.adapter.GGShowAdapter;
...
public class LiveGGShowFragment extends LiveBaseFragment  implements LiveContract.View{
    private LiveContract.Presenter presenter;
    private XRecyclerView ggshow_recyclerview;

    @Override
    protected int getLayoutId() {
        return R.layout.live_ggshowfragment;
    }
    ...
    protected void initView(View view) {
        ...
        ggshow_recyclerview.setLoadingMoreEnabled(false);
        ggshow_recyclerview.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override
    ...
    protected void loadData() {
        presenter.requestGGShowFragmentData();
    }
    ...
    public void GGShowBeanResult(GGShowBean ggShowBean) {
        ggshow_recyclerview.setAdapter(new GGShowAdapter(getActivity(),ggShowBean));
    }
